...
import com.example.expensemanagementsystem.databinding.ActivityAddTransactionBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnAddTransaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fStore.collection("Expenses").document(firebaseAuth.getUid())
                        .collection("Notes").document(id).set(transaction).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
